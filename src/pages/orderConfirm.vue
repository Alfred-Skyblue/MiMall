        ...
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              ...
              <div class="addr-add" @click="openAddressModal(item)">
...
export default {
  ...
  data() {
    return {
      ...
      userAction: null, // 用户的行为，0: 新增 1:编辑 2:删除
      showDelModal: false, //是否显示删除弹框
      showEditModal: false, // 是否显示新增或者编辑的弹框
      checkIndex: 0 //默认收货地址
    }
  },
  components: {
  ...
  methods: {
    ...
    getCartList() {
      this.axios.get('/carts').then(res => {
        ...
        this.count = this.cartList.reduce((count, item) => {
          return count + item.quantity
          // TODO:使用reduce方法叠加时，一定要在后面加上默认值0
        }, 0)
      })
    },
    // 打开新增地址弹框
